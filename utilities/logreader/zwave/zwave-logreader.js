...
function ZWaveLogReader() {
    ...
    function getDeviceClass(basic, generic, specific) {
        ...
        if (deviceClassBasic[basic] != null) {
            devClass = "<span class='badge badge-secondary'>" + deviceClassBasic[basic].name + "</span>";
        } else {
            devClass = "<span class='badge badge-secondary'>" + basic + "</span>";
        }
        if (deviceClass[generic] != null) {
            if (deviceClass[generic].specific != null && deviceClass[generic].specific[specific] != null) {
                devClass += " <span class='badge badge-secondary'>" + deviceClass[generic].specific[specific] + "</span>";
            } else {
                devClass += " <span class='badge badge-secondary'>" + deviceClass[generic].name + "</span>";
                devClass += " <span class='badge badge-secondary'>" + specific + "</span>";
            }
        } else {
            devClass += " <span class='badge badge-secondary'>" + generic + "</span>";
            devClass += " <span class='badge badge-secondary'>" + specific + "</span>";
        }
        return devClass;
    }
    ...
    var packetTypes = {
        ...
        71: {
            ...
            processor: processControllerCommand
        },
        72: {
    ...
    var commandClasses = {
        ...
        34: {
            ...
            processor: processApplicationStatus
        },
        37: {
            name: "SWITCH_BINARY",
            commands: {
        ...
        38: {
            ...
            processor: processSwitchMultilevel
        },
        39: {
            name: "SWITCH_ALL",
            processor: null,
        ...
        64: {
            ...
            processor: processThermostatMode,
            commands: {
                1: {
        ...
        67: {
            ...
            processor: processThermostatSetpoint
        },
        68: {
        ...
        143: {
            ...
            processor: processMultiCmdEncap
        },
        144: {
    ...
    var processList = [{
        ...
        ref: "Cmd",
        processor: processHandleCommand
    }, {
        ...
        string: "Configuration update set ",
        ref: "Config",
        processor: processConfigSet
    }, {
        string: "Configuration update ignored ",
        ref: "Config",
        processor: processConfigIgnored
    }, {
        ...
        ref: "Wakeup",
        content: "Node is <span class='badge badge-success'>AWAKE</span>",
        status: INFO
    }, {
        string: "Went to sleep",
        ref: "Wakeup",
        content: "Node is <span class='badge badge-danger'>ASLEEP</span>",
        status: INFO
    }, {
        ...
        string: "Device discovery resolved to thingType",
        processor: processThingType,
        ref: "THING-TYPE"
    }, {
        string: "Setting ONLINE",
        processor: processThingState,
        ref: "THING-STATE"
    }, {
        string: "Setting OFFLINE",
        processor: processThingState,
        ref: "THING-STATE"
    }, {
        string: "ZWave discovery: ",
        processor: processDiscovery,
        ref: "INCLUSION"
    }, {
        string: "processReceiveMessage input ",
    ...
    function getCommandClassName(cmdCls, cmdCmd) {
        var name = "";
        if (cmdCmd == null) {
            name = commandClasses[cmdCls].name;
        } else if (commandClasses[cmdCls].commands[cmdCmd] == null) {
    ...
    function processHandleCommand(node, process, message) {
        var data = {
            node: node
        };
        data.content = "<span class='badge badge-info'>COMMAND RECEIVED</span> <span class='badge badge-warning'>" + message.slice(message.indexOf("Command received ") + 17, message.indexOf(' -->')) + "</span> <span class='badge badge-secondary'>" + message.slice(message.indexOf("--> ") + 4) + "</span>";
        return data;
    }
    ...
    function processState(node, process, message) {
        ...
        data.content = "<span class='badge badge-info'>STATE UPDATE</span> <span class='badge badge-warning'>" + message.slice(message.indexOf("Updating channel state ") + 23, message.indexOf(' to ')) + "</span> <span class='badge badge-secondary'>" + message.slice(message.indexOf(" to ") + 4) + "</span>";
        return data;
    }
    ...
    function processBindingStart(node, process, message) {
        ...
        if (message.indexOf("started") != -1) {
            data.content = "Binding started. Version <span class='badge badge-secondary'>" + message.substr(message.indexOf("Version") + 8) + "</span>";
    ...
    function processThingType(node, process, message) {
        var content = "<span class='badge badge-info'>THING TYPE</span> <span class='badge'>";
        content += message.substring(message.search(process.string) + process.string.length) + "</span>";
        createNode(node);
        return {
            node: node,
            content: content
    ...
    function processThingState(node, process, message) {
        var state = message.substring(message.search(process.string) + 8);
        var content = "<span class='badge  badge-primary'>THING STATE</span> <span class='badge ";
        if (state == "ONLINE") {
    ...
    function processDiscovery(node, process, message) {
        var msgType = message.substring(message.search(process.string) + process.string.length);
        var content = "<span class='badge badge-info'>DISCOVERY</span> <span class='badge badge-dark'>";
        content += msgType.substring(0, msgType.indexOf(" ")) + "</span>";
        return {
            content: content
        };
    }
    ...
    function processSecureInclusion(node, process, message) {
        ...
        if (pos != -1) {
            content += "<span class='badge badge-secondary'>" + message.substr(pos + 6, message.substring(pos + 6).indexOf(" ")) + "</span>";
        }
    ...
    function processStage(node, process, message) {
        ...
        return {
            node: node,
            stage: stage,
            content: "Stage advanced to <span class='badge badge-secondary'>" + stage + "</span>"
        };
    }
    ...
    function processConfigSet(node, process, message) {
        var data = {
            result: SUCCESS
        };
        var cfg = message.substr(message.indexOf("Configuration update set ") + 25).split(" to ");
        if (cfg == null || cfg.length != 2) {
            return null;
        }
        data.content = "<span class='badge badge-success'>CONFIGURATION UPDATE</span> ";
        data.content += " <span class='badge badge-secondary'>" + cfg[0].trim() + "</span>";
        data.content += " <span class='badge badge-secondary'>" + cfg[1].trim() + "</span>";

        return data;
    }

    function processConfigIgnored(node, process, message) {
        var data = {
            result: SUCCESS
        };
        var cfg = message.substr(message.indexOf("Configuration update ignored ") + 29).split(" to ");
        if (cfg == null || cfg.length != 2) {
            return null;
        }
        data.content = "<span class='badge badge-danger'>CONFIGURATION UPDATE</span> ";
        data.content += " <span class='badge badge-secondary'>" + cfg[0].trim() + "</span>";
        data.content += " <span class='badge' badge-secondary>" + cfg[1].trim() + "</span>";
    ...
    function processCentralScene(node, endpoint, bytes) {
        ...
        switch (cmdCmd) {
            case 3: // CENTRAL_SCENE_NOTIFICATION
                data.content += " <span class='badge badge-primary'>SEQ=" + HEX2DEC(bytes[2]) + "</span>";
                data.content += " <span class='badge badge-secondary'>SCENE=" + HEX2DEC(bytes[4]) + "</span>";
                data.content += " <span class='badge badge-secondary'>ATTR=" + zwaveSceneKeys[HEX2DEC(bytes[3]) & 0x7] + "</span>";
                break;
        }
    ...
    function processWakeup(node, endpoint, bytes) {
        ...
        switch (cmdCmd) {
            ...
            case 6: // WAKE_UP_INTERVAL_REPORT
                ...
                data.content += " <span class='badge badge-secondary'>Period=" + interval + "</span>";
                data.content += " Reporting to <span class='badge badge-warning'>";
            ...
            case 10: // WAKE_UP_INTERVAL_CAPABILITIES_REPORT
                ...
                data.content += " <span class='badge badge-secondary'>Min=" + intervalMin + "</span>";
                data.content += " <span class='badge badge-secondary'>Max=" + intervalMax + "</span>";
                data.content += " <span class='badge badge-secondary'>Default=" + intervalDef + "</span>";
                data.content += " <span class='badge badge-secondary'>Step=" + intervalStp + "</span>";
                break;
        }
    ...
    function processColorSwitch(node, endpoint, bytes) {
        ...
        switch (cmdCmd) {
            case 3: // GET
                ...
                data.content += " <span class='badge badge-secondary'>";
    ...
    function processUserCode(node, endpoint, bytes) {
        var data = {
            result: SUCCESS
        };
        ...
        switch (cmdCmd) {
            case 2: // GET
                var code = HEX2DEC(bytes[2]);
                data.content += " <span class='badge badge-secondary'>CODE " + code + "</span>";
                break;
            case 1: // SET
            case 3: // REPORT
                var code = HEX2DEC(bytes[2]);
                data.content += " <span class='badge badge-secondary'>CODE " + code + "</span>";
                var status = HEX2DEC(bytes[3]);
                switch (status) {
                    case 0:
                        data.content += " <span class='badge badge-success'>AVAILABLE</span>";
                        break;
                    case 1:
                        data.content += " <span class='badge badge-secondary'>OCCUPIED</span>";
                        break;
                    case 2:
                        data.content += " <span class='badge badge-info'>RESERVED</span>";
                        break;
                    case 254:
                        data.content += " <span class='badge badge-danger'>STATUS NOT AVAILABLE</span>";
                        break;
                    default:
                        data.content += " <span class='badge badge-warning'>UNKNOWN</span>";
                        break;
                }
                break;
            case 5:
                var count = HEX2DEC(bytes[2]);
                data.content += " <span class='badge badge-secondary'>TOTAL CODES " + count + "</span>";
                break;
        }
    ...
    function processAlarm(node, endpoint, bytes) {
        ...
        switch (cmdCmd) {
            case 5: // ALARM_REPORT
                if (bytes.length >= 6) {
                    data.content += " <span class='badge badge-secondary'>V1 ";
                    if (events[HEX2DEC(bytes[2])] == null) {
                        data.content += "UNKNOWN[" + bytes[2] + "]";
                    } else {
                        data.content += events[HEX2DEC(bytes[2])].name;
                    }
                    data.content += "</span>";
                    data.content += " <span class='badge badge-secondary'>V1LEVEL=" + HEX2DEC(bytes[3]);
                    data.content += "</span>";
                ...
                if (bytes.length >= 6) {
                    ...
                    data.content += "</span>";
                    data.content += " <span class='badge badge-secondary'>EVENT=" + HEX2DEC(bytes[7]);
                    data.content += "</span>";
                }
                break;
        }
    ...
    function processMultiAssociation(node, endpoint, bytes) {
        ...
        switch (cmdCmd) {
            case 3: // REPORT
                var groupNum = HEX2DEC(bytes[2]);
                var entryCnt = HEX2DEC(bytes[3]);
                data.content += " <span class='badge badge-secondary'>GROUP_" + groupNum + "</span>";
                data.content += " <span class='badge badge-secondary'>Includes " + entryCnt + " entries</span>";

                var cnt = 5;
                for (; cnt < bytes.length; cnt++) {
                    if (HEX2DEC(bytes[cnt]) == 0) {
                        cnt++
                        break;
                    }
                    data.content += " <span class='badge badge-warning'>NODE " + HEX2DEC(bytes[cnt]) + "</span>";
                }
                for (; cnt < bytes.length; cnt += 2) {
                    data.content += " <span class='badge badge-warning'>NODE " + HEX2DEC(bytes[cnt]) + ":" + HEX2DEC(bytes[cnt + 1]) + "</span>";
                }
                if (bytes.length == 6) {
                    data.content += " <span class='badge badge-dark'>empty</span>";
                }
                break;
            case 1: // SET
                var groupNum = HEX2DEC(bytes[2]);
            ...
            case 4: // REMOVE
                ...
                data.content += " <span class='badge badge-secondary'>GROUP_" + groupGet + "</span>";
                break;
            case 6: // ASSOCIATION_GROUPINGSREPORT
                var groupCnt = HEX2DEC(bytes[2]);
                addNodeInfo(node, "associationGroups", groupCnt);
                data.content += " <span class='badge badge-secondary'>Supports " + groupCnt + " groups</span>";
                break;
        }
    ...
    function processAssociation(node, endpoint, bytes) {
        ...
        switch (cmdCmd) {
            ...
            case 4: // REMOVE
                ...
                data.content += " <span class='badge badge-secondary'>GROUP_" + groupReport + "</span>";
                for (var a = 3; a < bytes.length; a++) {
                    data.content += " <span class='badge badge-warning'>NODE " + HEX2DEC(bytes[a]) + "</span>";
                }
                if (bytes.length == 3) {
                    data.content += " <span class='badge badge-dark'>empty</span>";
                }
            ...
            case 3: // ASSOCIATION_REPORT
                ...
                data.content += " <span class='badge badge-secondary'>GROUP_" + groupReport + "</span>" + " <span class='badge badge-secondary'>MAX_NODES " + maxNodes + "</span>";
    ...
    function processCrcEncap(node, endpoint, bytes) {
        var data = {
            result: SUCCESS,
            node: node
        };
        ...
        data.endClassPacket = processCommandClass(node, endpoint, bytes.slice(2));
        data.content = data.content + " " + data.endClassPacket.content;
        return data;
    }

    function processMultiCmdEncap(node, endpoint, bytes) {
        var data = {
            result: SUCCESS,
            node: node
        };
        ...
        var cmdCls = HEX2DEC(bytes[0]);
        var cmdCmd = HEX2DEC(bytes[1]);
        var cmdCnt = HEX2DEC(bytes[2]);
        data.content = getCommandClassName(cmdCls, cmdCmd);
        data.content += " <span class='badge badge-secondary'>" + cmdCnt + " CMDS</span>";

        var offset = 3;
        for (var c = 0; c < cmdCnt; c++) {
            data.endClassPacket = processCommandClass(node, endpoint, bytes.slice(offset + 1));
            data.content = data.content + " " + data.endClassPacket.content;
            offset += HEX2DEC(bytes[offset]) + 1;
        }
        return data;
    }
    ...
    function processAssociationInfo(node, endpoint, bytes) {
        ...
        switch (cmdCmd) {
            ...
            case 2: // ASSOCIATION_GROUP_INFO_NAME_REPORT
                ...
                data.content += " <span class='badge badge-secondary'>GROUP_" + groupNameGroup + "</span>";
                data.content += " <span class='badge badge-secondary'><span class='icon-quotes-left'></span> " + groupName + " <span class='icon-quotes-right'></span></span>";
                break;
        }
        ...
        switch (cmdCmd) {
            ...
            case 3: // REPORT
                ...
                if (year == 0 && month == 0 && day == 0 && hour == 0 && minute == 0 && second == 0) {
                    data.content += " <span class='badge badge-warning'>TIME NOT SET</span>"
                } else {
                    data.content += " <span class='badge badge-secondary'>" + zeroPad(hour, 2) + ":" + zeroPad(minute, 2) + ":" + zeroPad(second, 2) + " " + day + "/" + month + "/" + year + "</span>";
                }
                break;
        }
            ...
            case 1: // GET
                if (bytes.length >= 3) {
                    ...
                    if (alarmSensors[getType] == null) {
                        ...
                        data.content += " <span class='badge badge-secondary'>" + alarmSensors[getType] + "</span>";
                    }
                }
                break;
            case 2: // REPORT
                ...
                if (alarmSensors[repType] == null) {
                    ...
                    data.content += " <span class='badge badge-secondary'>" + alarmSensors[repType] + "=" + repValue + "</span>";
                }
                break;
    ...
    function processApplicationStatus(node, endpoint, bytes) {
        var data = {
            result: SUCCESS
        };
        var cmdCls = HEX2DEC(bytes[0]);
        ...
        switch (cmdCmd) {
            case 1:
                switch (HEX2DEC(bytes[2])) {
                    case 0:
                        data.content += " <span class='badge badge-secondary'>TRY AGAIN LATER</span>";
                        break;
                    case 1:
                        data.content += " <span class='badge badge-secondary'>TRY AGAIN IN " + HEX2DEC(bytes[3]) + " SECONDS</span>";
                        break;
                    case 2:
                        data.content += " <span class='badge badge-secondary'>REQUEST QUEUED</span>";
                        break;
                }
                break;
            case 2:
    ...
    function processSwitchMultilevel(node, endpoint, bytes) {
        var data = {
            result: SUCCESS
        };
        ...
        data.content = getCommandClassName(cmdCls, cmdCmd);
        switch (cmdCmd) {
            case 1: // SWITCH_MULTILEVEL_SET
                if (HEX2DEC(bytes[2]) == 0xFF) {
                    data.content += " <span class='badge badge-secondary'>RESTORE LAST LEVEL</span>";
                } else {
                    data.content += " <span class='badge badge-secondary'>" + HEX2DEC(bytes[2]) + "%</span>";
                }
                break;
            case 3: // SWITCH_MULTILEVEL_REPORT
                data.content += " <span class='badge badge-secondary'>" + HEX2DEC(bytes[2]) + "%</span>";
                break;
            case 4: // SWITCH_MULTILEVEL_START_LEVEL_CHANGE
                var direction = ((HEX2DEC(bytes[2]) & 0x40) != 0) ? "DOWN" : "UP";
                data.content += " <span class='badge badge-secondary'>DIRECTION=" + direction + "</span>";
                data.content += " <span class='badge badge-secondary'>LEVEL=" + HEX2DEC(bytes[3]) + "</span>";
                break;
        }
        ...
        switch (cmdCmd) {
            ...
            case 3: // SWITCH_BINARY_REPORT
                if (HEX2DEC(bytes[2]) == 0) {
                    data.content += " <span class='badge badge-secondary'>OFF</span>";
                } else if (HEX2DEC(bytes[2]) == 255) {
                    data.content += " <span class='badge badge-success'>ON</span>";
                } else {
                    data.content += " <span class='badge badge-warning'>UNKNOWN</span>";
                }
                break;
        ...
        switch (cmdCmd) {
            case 2: // SENSOR_BINARY_GET
                if (bytes.length >= 3) {
                    ...
                    if (binarySensors[typeGet] == null) {
                        ...
                        data.content += " <span class='badge badge-secondary'>" + binarySensors[typeGet] + "</span>";
                    }
                }
                break;
            case 3: // SENSOR_BINARY_REPORT
                if (bytes.length > 3) {
                    ...
                    data.content += " <span class='badge badge-secondary'>" + bytes[2] + "</span>";
            ...
            case 1: // METER_GET
                if (bytes.length >= 3) {
                    ...
                    if (meterSensors[meterType].scales[typeGet] == null) {
                        data.content += " <span class='badge badge-secondary'>UNKNOWN SCALE " + typeGet + "</span>";
                    } else {
                        data.content += " <span class='badge badge-secondary'>" + meterSensors[meterType].name + "_" + meterSensors[meterType].scales[typeGet].name + "</span>";
                    }
                }
                break;
            case 2: // METER_REPORT
    ...
    function processThermostatMode(node, endpoint, bytes) {
        var data = {
            result: SUCCESS
        };
        ...
        data.content = getCommandClassName(cmdCls, cmdCmd);
        switch (cmdCmd) {
            case 5: // THERMOSTAT_MODE_SUPPORTED_REPORT
                for (var i = 0; i < bytes.length - 3; ++i) {
                    var a = HEX2DEC(bytes[i + 3]);
                    for (var bit = 0; bit < 8; ++bit) {
                        if ((a & (1 << bit)) === 0) {
                        ...
                        var name;
                        if (thermostatModeTypes[index] != null) {
                            name = thermostatModeTypes[index];
                        } else {
                            name = "UNKNOWN[" + index + "]"
                        }
                        data.content += " <span class='badge badge-secondary'>" + name + "</span>";
                    }
                }
                break;
        }
    ...
    function processThermostatSetpoint(node, endpoint, bytes) {
        var data = {
            result: SUCCESS
        };
        ...
        data.content = getCommandClassName(cmdCls, cmdCmd);
        switch (cmdCmd) {
            case 1: // THERMOSTAT_SETPOINT_SET
            case 3: // THERMOSTAT_SETPOINT_REPORT
                var setpointReport = HEX2DEC(bytes[2]);
                var scale = (HEX2DEC(bytes[3]) >> 3) & 0x03;
                if (thermostatSetpointTypes[index] != null) {
                    setpointReport = thermostatSetpointTypes[index];
                }
                data.content += " <span class='badge badge-secondary'>TYPE=" + setpointReport + "</span>";
                data.content += " <span class='badge badge-secondary'>SCALE=" + scale + "</span>";
                break;
            case 5: // THERMOSTAT_SETPOINT_SUPPORTED_REPORT
                for (var i = 0; i < bytes.length - 3; ++i) {
                    var a = HEX2DEC(bytes[i + 3]);
                    for (var bit = 0; bit < 8; ++bit) {
                        if ((a & (1 << bit)) === 0) {
                        ...
                        var name;
                        if (thermostatSetpointTypes[index] != null) {
                            name = thermostatSetpointTypes[index];
                        } else {
                            name = "UNKNOWN[" + index + "]"
                        }
                        data.content += " <span class='badge badge-secondary'>" + name + "</span>";
            ...
            case 4: // SENSOR_MULTI_LEVEL_GET
                if (bytes.length >= 3) {
                    ...
                    if (multilevelSensors[typeGet] == null) {
                        data.content += " <span class='badge badge-secondary'>" + typeGet + "</span>";
                    } else {
                        data.content += " <span class='badge badge-secondary'>" + multilevelSensors[typeGet] + "</span>";
                    }
                }
                break;
    ...
    function processVersion(node, endpoint, bytes) {
        ...
        switch (cmdCmd) {
            case 18:
                data.content += " <span class='badge badge-secondary'>APPLICATION_VERSION</span>";
                data.content += " <span class='badge badge-secondary'>VERSION " + HEX2DEC(bytes[5]) + "." + HEX2DEC(bytes[6]) + "</span>";
                break;
            case 19:
                ...
                data.content += " <span class='badge badge-secondary'>" + cmdClass + "</span>";
                break;
            case 20:
                if (commandClasses[cmdPrm] == undefined) {
                    cmdClass = "UNKNOWN(" + cmdPrm + ")";
                ...
                data.content += " <span class='badge badge-secondary'>" + cmdClass + "</span> <span class='badge badge-secondary'>VERSION " + version + "</span>";
                break;
        }
    ...
    function processSecurity(node, endpoint, bytes) {
        ...
        switch (cmdCmd) {
            case 5: // SECURITY_SCHEME_REPORT
                data.content += " <span class='badge badge-secondary'>SCHEME_" + cmdPrm + "</span>";
                break;
            case 3: // SUPPORTED_REPORT
                ...
                for (var c = 3; c < bytes.length; c++) {
                    ...
                    data.expandedContent += "<tr><td>" + lineHeader + "</td><td><span class='badge badge-secondary'>" + id + "</span></td></tr>";
                    lineHeader = "";
                }
                data.expandedContent += "</table>";
                break;
            case 128: // SECURITY_NONCE_REPORT
                data.content += " <span class='badge badge-secondary'>NONCE ID " + cmdPrm + "</span>";
                break;
            case 129: // ENCAP
    ...
    function processConfiguration(node, endpoint, bytes) {
        ...
        data.content = getCommandClassName(cmdCls, cmdCmd);
        data.content += " <span class='badge badge-secondary'>PARAM_" + data.param_id + "</span>";
    ...
    function processManufacturer(node, endpoint, bytes) {
        ...
        var cmdCmd = HEX2DEC(bytes[1]);
        data.content = getCommandClassName(cmdCls, cmdCmd);
        data.content += " <span class='badge badge-secondary'>" + getNodeInfo(node, "manufacturer") + ":" + getNodeInfo(node, "deviceType") + ":" + getNodeInfo(node, "deviceID") + "</span>";
    ...
    function processMultiChannelReport(node, endpoint, bytes) {
        ...
        switch (cmdCmd) {
            case 8:
                data.content += " <span class='badge badge-secondary'>" + HEX2DEC(bytes[3]) + " ENDPOINTS</span>";
                if ((HEX2DEC(bytes[2]) & 0x40) != 0) {
                    data.content += " <span class='badge badge-warning'>DYNAMIC</span>";
                }
                if ((HEX2DEC(bytes[2]) & 0x80) != 0) {
                    data.content += " <span class='badge badge-warning'>COUNT CHANGING</span>";
                }
                break;
            case 10:
                ...
                data.content += " <span class='badge badge-info'>ENDPOINT-" + data.endPoint + "</span>";
    ...
    function processMultiChannelEncapV1(node, endpoint, bytes) {
        ...
        data.content += " <span class='badge badge-info'>EP-" + data.endPoint + "</span>";
    ...
    function processMultiChannelEncapV2(node, endpoint, bytes) {
        ...
        data.content += " <span class='badge badge-info'>EP-" + data.endPoint + " -> EP-" + data.endPointDest + "</span>";
        if (data.endClassPacket != null) {
            data.content += " " + data.endClassPacket.content;
        }
        return data;
        ...
        if (direction == "TX") {
            ...
            if (type == REQUEST) {
                ...
                if (HEX2DEC(bytes[0]) == 0) {
                    data.content = "SUC ID: <span class='badge badge-dark'>NOT SET</span>";
                } else {
                    data.content = "SUC ID: <span class='badge badge-warning'>NODE " + getNodeInfo(255, "sucID") + "</span>";
                }
            }
        }
    ...
    function processMemoryGetId(node, direction, type, bytes, len) {
        ...
        if (direction == "TX") {
            ...
            if (type == REQUEST) {
                ...
                data.content = "MemoryGetId: HomeID <span class='badge badge-secondary'>" + getNodeInfo(data.node, "homeID") + "</span> ControllerID <span class='badge badge-warning'>NODE " + getNodeInfo(data.node, "controllerID") + "</span>";
            }
        }
    ...
    function processAppUpdate(node, direction, type, bytes, len) {
        ...
        if (direction == "TX") {
            ...
            if (type == REQUEST) {
                ...
                } else if (lastNifRequest != 0) {
                    data.node = lastNifRequest;
                    lastNifRequest = 0;
                }
                data.content = "";
    ...
    function processAddNode(node, direction, type, bytes, len) {
        ...
        data.content = "<span class='badge badge-primary'>";
        if (direction == "TX") {
            if (type == REQUEST) {
                ...
                if (HEX2DEC(bytes[0]) & 0x80) {
                    data.content += " <span class='badge badge-danger'>HIGH POWER</span>";
                }
                if (HEX2DEC(bytes[0]) & 0x40) {
                    data.content += " <span class='badge badge-danger'>NWI</span>";
                }
            }
        } else {
            if (type == REQUEST) {
                ...
                for (var i = 0; i < 29; i++) {
                    ...
                    for (var j = 0; j < 8; j++) {
                        ...
                        if (b1 == b2) {
                            ...
                            data.expandedContent += " <span class='badge badge-warning'>NODE " + nodeLoop + "</span>";
                        }
                    }
                }
    ...
    function processRequestNodeInfo(node, direction, type, bytes, len) {
        ...
        if (direction == "TX") {
            ...
            if (type == REQUEST) {
                ...
                if (HEX2DEC(bytes[0]) == 0) {
                    data.content += "<span class='badge badge-danger'>FAILED</span>";
                } else {
                    data.content += "<span class='badge badge-success'>OK</span>";
                }
                data.node = lastCmd.node;
            }
        }
    ...
    function processAssignReturnRoute(node, direction, type, bytes, len) {
        ...
        if (direction == "TX") {
            ...
            data.content = " <span class='badge badge-warning'>NODE " + HEX2DEC(bytes[0]) + "</span>";
            data.content += " <span class='badge badge-secondary'>to</span>";
            data.content += " <span class='badge badge-warning'>NODE " + HEX2DEC(bytes[1]) + "</span>";
            ...
            if (type == REQUEST) {
                data.node = lastCmd.node;
                if (HEX2DEC(bytes[1]) == 0) {
                    data.content = " <span class='badge badge-success'>SUCCESS</span>";
                } else {
                    data.content = " <span class='badge badge-danger'>FAILURE</span>";
                }
            } else {
                data.node = lastCmd.node;
                if (HEX2DEC(bytes[1]) != 0) {
                    data.content = " <span class='badge badge-success'>STARTED</span>";
                } else {
                    data.content = " <span class='badge badge-danger'>FAILURE</span>";
                }
            }
    ...
    function processControllerCommand(node, direction, type, bytes, len) {
        var data = {
            result: SUCCESS
        };
        if (direction == "TX") {
    ...
    function processControllerInfo(node, direction, type, bytes, len) {
        ...
        if (direction == "RX" && type == RESPONSE) {
            ...
            data.content = "Controller Info <span class='badge badge-secondary'>" + getNodeInfo(data.node, "manufacturer") + ":" + getNodeInfo(data.node, "deviceType") + ":" + getNodeInfo(data.node, "deviceID") + "</span>";
        }
    ...
    function processSerialApiTimeouts(node, direction, type, bytes, len) {
        ...
        if (direction == "TX" && type == REQUEST) {
            data.content = "<span class='badge badge-secondary'>FRAME=" + (HEX2DEC(bytes[0]) * 10) + "s</span> <span class='badge badge-secondary'>BYTE=" + (HEX2DEC(bytes[1]) * 10) + "ms</span>";
    ...
    function processFailedNode(node, direction, type, bytes, len) {
        ...
        if (direction == "TX") {
            data.node = HEX2DEC(bytes[0]);
            data.content = "Check if <span class='badge badge-warning'>NODE " + data.node + "</span> is failed";
            createNode(data.node);
            ...
            data.node = lastCmd.node;
            if (type == RESPONSE) {
                data.content = "<span class='badge badge-warning'>NODE " + data.node + "</span> is marked as ";
                if (HEX2DEC(bytes[0]) === 0) {
                    data.content += "<span class='badge badge-success'>HEALTHY</span>";
                } else {
                    data.content += "<span class='badge badge-danger'>FAILED</span>";
                }
    ...
    function processSendData(node, direction, type, bytes, len) {
        ...
        if (direction == "TX") {
            ...
            if (txOptions == 0) {
                ...
                if (txOptions & 0x01) {
                    sendData.txoptions += "&nbsp;<span class='badge badge-secondary'>ACK</span>";
                }
                if (txOptions & 0x04) {
                    sendData.txoptions += "&nbsp;<span class='badge badge-secondary'>AUTO_ROUTE</span>";
                }
                if (txOptions & 0x20) {
                    sendData.txoptions += "&nbsp;<span class='badge badge-secondary'>EXPLORE</span>";
                }
            }
            ...
            if (type == REQUEST) {
                ...
                switch (status) {
                    case 0: // COMPLETE_OK
                        ...
                        sendData.content += "<span class='badge badge-success'>ACK RECEIVED</span> from device in ";
                        if (sendData.responseTime < 100) {
                            sendData.content += "<span class='badge badge-success'>";
                        } else if (sendData.responseTime < 1000) {
                            sendData.content += "<span class='badge badge-warning'>";
                        } else {
                            sendData.content += "<span class='badge badge-danger'>";
                        }
                        sendData.content += sendData.responseTime + "ms</span>";
                        break;
                    ...
                    case 2: // COMPLETE_FAIL
                        updateNodeResponse(node, -1);
                        setStatus(sendData, ERROR);
                        sendData.content += "<span class='badge badge-danger'>FAILED</span> after " + sendData.responseTime + "ms";
                        break;
                ...
                if (HEX2DEC(bytes[0]) > 0) {
                    // Success
                    sendData.content = "<span class='badge badge-success'>" + lastSendData.callback + "</span> " + "<span class='badge badge-success'>ACCEPTED BY CONTROLLER</span>";
                    setStatus(sendData, SUCCESS);
                } else {
                    // Error
                    sendData.content = "<span class='badge badge-danger'>" + lastSendData.callback + "</span> " + "<span class='badge badge-danger'>REJECTED BY CONTROLLER</span>";
                    setStatus(sendData, ERROR);
                }
            }
        }
    ...
    function processReceiveQueue(node, process, message) {
        if (lastPacketRx == null) {
            return null;
        }

        var queueData = message.substr(message.indexOf(process.string) + process.string.length).trim().split("<>");

        var queueLen = parseInt(queueData[0]);
        var queueRem = parseInt(queueData[1]);
        var logtype = "success";
        if (parseInt(queueRem) < 16) {
            logtype = "danger";
        } else if (parseInt(queueLen) > 16) {
            logtype = "warning";
        }
        lastPacketRx.queue = "<span class='badge badge-" + logtype + "'>" + queueLen + " /" + (queueRem + queueLen) + "</span>";
    }
    ...
    function processPacket(direction, node, process, message) {
        ...
        if (frameType == 6) {
            // NAK
            packet.content = "<span class='badge " + (process.ref == "RXPacket" ? "badge-success'>RX" : "badge-danger'>TX") + "</span> <span class='badge badge-pill badge-success'>ACK</span>";
            return packet;
        } else if (frameType == 21) {
            // NAK
            packet.content = "<span class='badge " + (process.ref == "RXPacket" ? "badge-success'>RX" : "badge-danger'>TX") + "</span> <span class='badge badge-pill badge-danger'>NAK</span>";
            return packet;
        } else if (frameType == 24) {
            // CAN
            packet.content = "<span class='badge " + (process.ref == "RXPacket" ? "badge-success'>RX" : "badge-danger'>TX") + "</span> <span class='badge badge-pill badge-warning'>CAN</span>";
            return packet;
        }
        ...
        packet.content = "<span class='badge ";
        packet.content += process.ref == "RXPacket" ? "badge-success'>RX" : "badge-danger'>TX";
        packet.content += "</span>";
        packet.content += " <span class='badge";
        packet.content += packet.reqType == REQUEST ? " badge-warning" : " badge-secondary";
        packet.content += "'>" + packet.reqType + "</span> ";
        packet.content += "<span class='badge badge-info'>" + packet.class + "</span> ";
    ...
    function logProcessLine(line) {
        ...
        if (line.indexOf("-") == -1 || line.indexOf(":") < line.indexOf("-")) {
            ...
            timeString = line.substr(line.indexOf(" ") + 1);
        }
        time = moment(timeString.substr(0, 12), "HH:mm:ss.SSS");
